...
{% include_relative _partials/stayInWebApp.js %} $(function() { $.stayInWebApp(); });

{% include_relative _partials/list.js %}
$(document).ready(function() { var options = { valueNames: [ 'book__title', 'book__author' ] }; var userList = new List('booksearch', options); });